...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2022 at 08:50 PM
...
('1001', 'Jadid Rahman', 'jadid@gmail.com', '1234567@'),
('1002', 'Audrib', 'Audrib@gmial.com', '1234'),
('1005', 'karim', 'karim@gmail.com', 'Audrib@Audrib');
...
('1234', 'sakib', 'alhabibh47@gmail.com', '01781596488', 'male', '1999-06-03', 'kuril'),
...
(26, '1999', 'Habib', '2022-04-17', '2022-04-28', '');
...
(11, '2022-03-06 (1).png', '2022-04-16 18:48:03');
...
(1, 'There is no class tomorrow (04/04/2022)', '2022-04-04 13:34:32'),
(3, 'Home Test 1\r\nDate: 6/4/2021 at 9.30 AM Sharply\r\n', '2022-04-06 15:24:24');
...
(25, '1250773429', 'A Prayer for Owen Meany', 'John Irving', '3rd edition', 1999, '2022-04-16 18:48:48');
...
(1, 'It is to notify to all concerned that the School will remain closed on Thursday, April 28th 2021 due to Holiday, 2022.  ', '2022-04-22 11:23:55'),
(3, 'It is to notify to all concerned that the School will remain closed on Sunday, February 21,  2021 due to Language Movement Day 2022.  ', '2022-04-16 09:33:20');
...
('1999', 'Habib', 'alhabibh47@gmail.com', '01781596488', 'male', '1999-06-03', 'Nine', 'A', '13', 'kuril Bisshoroad', 'SakibHabib93@', ''),
...
('4001', 'Audrib saha', 'Audrib@gmail.com', '01756551234', 'male', '2004-06-16', 'Seven', 'B', '24', 'nikunja-2', '2554', '45'),
...
('2001', 'Jhon', 'Jhon@gmail.com', '01111111111', 'male', '1984-08-09', '', '4567'),
('2002', 'Leo', 'Leo@gmail.com', '01723456789', 'male', '2009-07-15', '', '1234@1234'),
('2003', 'Virgo', 'Virgo@gmail.com', '01745454545', 'male', '2016-02-09', '', '12341234@'),
('2006', 'Gemini', 'Gemini@gmail.com', '01756565656', 'male', '2013-01-02', 'Math', '12345@@123'),
('2009', 'Mir', 'Mir@gmail.com', '01785858585', 'Male', '2013-06-23', 'Math', '1234567@'),
('2011', 'anirban', 'anirban@gmaill.com', '01745343434', 'female', '2019-03-16', '', '12345678@'),
('2014', 'Kawsur', 'Kawsur@gmail.com', '01776666666', 'male', '2021-03-31', '', '1234567@@');
...
--
ALTER TABLE `leave_request`
  MODIFY `sl` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
